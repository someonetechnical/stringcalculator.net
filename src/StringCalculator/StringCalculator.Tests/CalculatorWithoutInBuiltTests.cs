...
{
    public class CalculatorWithoutInBuiltTests
    {
        [Fact]
        public void Add_PassNull_ThrowsArgumentNullException()
        {
            ...
            //Act, Assert
            Assert.Throws<ArgumentNullException>(() => CalculatorWithoutBuiltIn.Add(value));
        }
        ...
        public void Add_PassEmptyString_Returns0()
        {
            ...
            //Act
            var result = CalculatorWithoutBuiltIn.Add(value);
        ...
        public void Add_PassStringNegativeValue_ThrowsException()
        {
            ...
            //Act, Assert
            var exception = Assert.Throws<NotSupportedException>(() => CalculatorWithoutBuiltIn.Add(value));
        ...
        public void Add_PassStringNegativeSymbolOnly_ThrowsException()
        {
            ...
            //Act, Assert
            Assert.Throws<FormatException>(() => CalculatorWithoutBuiltIn.Add(value));
        }
